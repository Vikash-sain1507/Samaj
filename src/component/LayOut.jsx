  ...
  return (
    <Box sx={{ py: 8, px: 2, backgroundColor: "#fff" }}>
      ...
      <Typography variant="body1" textAlign="center" maxWidth="600px" mx="auto" mb={4}>
        SAMAJ is a platform that allows educators to create virtual classrooms that are just as effective as in-person classrooms. It includes all the tools you need for teaching and learning online.
      </Typography>
  ...
  <Grid item xs={12} md={6}>
    <Box sx={{ maxWidth: "480px", mx: "auto", textAlign: "center" }}>
      <Typography variant="h6" fontWeight="bold" color="#9b51e0" gutterBottom>
        Everything you can do in a physical classroom, you can do with SAMAJ
      </Typography>
      <Typography variant="body1" color="textSecondary">
        SAMAJ’s school management software helps traditional and online schools manage scheduling, attendance, payments, and more.
